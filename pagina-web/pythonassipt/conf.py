...
BLOG_AUTHOR = "Paulo Jabardo"  # (translatable)
BLOG_TITLE = "Python na ASSIPT"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://pythonassipt.vento.eng.br/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pythonassipt.vento.eng.br/"
BLOG_EMAIL = "pjabardo@gmail.com"
BLOG_DESCRIPTION = "Página de apoio para o curso de Python para iniciantes na ASSIPT"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "pythonassipt"
